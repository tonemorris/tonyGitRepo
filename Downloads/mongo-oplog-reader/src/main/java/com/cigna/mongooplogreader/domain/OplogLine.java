...
import com.cigna.mongooplogreader.util.MongoOplogOperation;
...
public class OplogLine {
  ...
  public OplogLine(MongoOplogOperation operation, DateTime timestamp, String nameSpace, String data, Document docData) {
    super();
